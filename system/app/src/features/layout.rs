...
pub fn calculate_layout(window: &Window, keys: &[Tone]) -> PianoLayout {
    ...
    let white_key_width = (usable_width - KEY_GAP * (white_key_count as f32 - 1.0)) / white_key_count as f32;
    ...
    let total_width = white_key_count as f32 * white_key_width + (white_key_count as f32 - 1.0) * KEY_GAP;
